...
target_file_name = 'images/audi.jpg'
# s3client.upload_file("Audi_A6.jpg", config.AWS_BUCKET_NAME, target_file_name)

# UPDATE
# s3client.upload_file("Audi_A6_2.jpg", config.AWS_BUCKET_NAME, target_file_name)
